...
class ClsTuningWithPrompt(BertPreTrainedModel):
    ...
    def forward(self, inputs):
        text_indices, text_mask, text_segments, mask_position, verbalizer_indices, verbalizer_mask, label, domain = inputs
