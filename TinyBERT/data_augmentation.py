...
class AugmentProcessor(object):
    def __init__(self, augmentor, glue_dir, task_name):
        ...
        self.augment_ids = {'mrpc': [3, 4], 'mnli': [8, 9], 'CoLA': [3], 'sst2': [0],
                            'stsb': [7, 8], 'qqp': [3, 4], 'qnli': [1, 2], 'rte': [1, 2]}

        self.filter_flags = { 'mrpc': True, 'mnli': True, 'CoLA': False, 'sst2': True,
                              'stsb': True, 'qqp': True, 'qnli': True, 'rte': True}
...
def main():
    ...
    parser.add_argument("--task_name", default=None, type=str, required=True,
                        help="Task(eg. CoLA, sst2) that we want to do data augmentation for its train set")
